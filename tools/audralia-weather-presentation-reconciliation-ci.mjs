...
import {createSemanticRuntimeGuard} from './audralia-gesture-matrix-runtime-watchdog.self-test.v1.mjs';
...
try{
  ...
  assert.equal(enabled.composition.evidence.finalAblationMode,'NONE','ENABLED_VARIANT_ABLATION_STATE_WRONG');assert.equal(ablated.composition.evidence.finalAblationMode,'V6_FIELDS_ABLATED','ABLATION_VARIANT_STATE_WRONG');assert.notEqual(enabled.composition.evidence.finalShaderSha256,ablated.composition.evidence.finalShaderSha256,'V6_ABLATION_FINAL_SHADER_HASH_IDENTICAL');

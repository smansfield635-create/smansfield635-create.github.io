...
const RENDERER_CUSTODY_RENDERER_PATH =
  '../../render/persistent-live-renderer.run8e-r3c.renderer-selection-custody-minimal-v1.js?v=material-expression-pass-a-v1';
...
const WATER_INDEX_SPAN_RENDERER_PATH =
  '../../render/persistent-live-renderer.run8e-r3c.water-index-span-attribution-v1.js';
...
const OCEAN_PROOF_RENDERER_PATH =
  '../../render/persistent-live-renderer.run8e-r3c.ocean-expression-proof-v1.js';
...
const rendererCustodyRequested = true;
const waterIndexSpanRequested = false;
const waterAttributionRequested = false;
const oceanProofRequested = false;
const additiveVisualRequested = false;
const cp2LiveDifferentialRequested = false;
const selectedRendererPath = RENDERER_CUSTODY_RENDERER_PATH;
...
export const H_EARTH_CP2_LIVE_DIFFERENTIAL_ADMISSION = Object.freeze({
  ...
  waterIndexSpanQueryKey: WATER_INDEX_SPAN_QUERY_KEY,
  waterIndexSpanQueryValue: WATER_INDEX_SPAN_QUERY_VALUE,

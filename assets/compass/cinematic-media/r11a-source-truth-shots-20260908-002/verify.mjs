...
process.stdout.write(JSON.stringify({schema:'R11A_SOURCE_TRUTH_SHOT_VERIFICATION_RECEIPT_v1',result:'PASS_AT_SOURCE_AND_PROOF_CONTRACT_LEVEL',shots:['S00','S01'],manifestSha256:digest,acceptedS00Preserved:true,persistentObjectIds:ids,objectReplacementCount:0,genuineManipulation:'TIMELINE_DRIVEN_3D_REORIENTATION',starMotionContinuity:'PASS_NO_PROGRESS_0_24_POSITION_RESET',manipulationFrameInterval:[303,368],ownerPreviewDurationSeconds:9,brandDescriptor:s.brandDescriptor,introContextPresentation:'DEFERRED_TO_REMAINDER_OF_CINEMATIC_NO_S01_FRAME',audienceInteractionRequired:false,interactiveSubsystemCreated:false,terminalForeground:'ORIENTATION',ownerAcceptance:'PENDING',fullMasterAuthorized:false,liveMutationAuthorized:false},null,2)+'\n');

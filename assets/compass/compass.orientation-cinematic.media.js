export const CINEMATIC_MEDIA_MANIFEST=Object.freeze({
  ...
  version:'storyboard-v2-clean-recovery-integrated-20260905-001',
  sourceMain:'8d7c6a34ced8b01b6627f704c5c38492e3e67f34',
  integrationBase:'c4bd4fc49f0215085d0efa055464ede797c53fcf',
  specificationCommit:'88473442959299d6f6af82396917f0578074cab2',
  storyboardIssue:2756,
  status:'STORYBOARD_V2_SOURCE_TRUE_FULL_FILM_INTEGRATION',
  ...
  sourceBindings:Object.freeze({
    ...
    mirrorlandForest:Object.freeze({path:'characters/forest-system.mjs',blob:'919b5e46a7d28ef4b6e1847b24f603c1cfaf4102',use:'S05_DETACHED_MATURE_FOREST_RENDERER'}),
    mirrorlandClouds:Object.freeze({path:'characters/cloud-system.mjs',blob:'9974994570438a318a5858a15866d7d46acbeb5e',use:'S05_DETACHED_MATURE_CLOUD_RENDERER'}),
...
export function assertCinematicMediaManifest(manifest=CINEMATIC_MEDIA_MANIFEST){
  ...
  if(manifest?.sourceMain!=='8d7c6a34ced8b01b6627f704c5c38492e3e67f34')throw new Error('CINEMATIC_MEDIA_BASE_MISMATCH');
  if(manifest?.integrationBase!=='c4bd4fc49f0215085d0efa055464ede797c53fcf')throw new Error('CINEMATIC_MEDIA_INTEGRATION_BASE_MISMATCH');
  ...
  if(manifest?.runtimeEmbeddingAllowed!==false||manifest?.sourceWorldsRequiredBeforeMasterClock!==false||manifest?.lateShotSourcesMayBlockMasterStart!==false)throw new Error('CINEMATIC_MEDIA_STARTUP_ARCHITECTURE_MISMATCH');

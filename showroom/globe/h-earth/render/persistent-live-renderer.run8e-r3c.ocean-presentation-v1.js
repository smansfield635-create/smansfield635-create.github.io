...
export function createHEarthRun8ER3CPersistentRenderer({ canvas, width = 640, height = 360 } = {}) {
  ...
  function getResourceReceipt() {
    ...
    return {
      ...
      presentationProfile: {
        oceanGraphicalExpressionProof: false, oceanPresentation: true, continuousWaterExpression: true, multiScaleDeterministicSurface: true,
        shorelineTruthMutated: false, waterTruthMutated: false, fluidSimulationClaimed: false, productionExpressionCandidate: true,

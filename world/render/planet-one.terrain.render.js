/*
  ...
  PURPOSE=
  PAIR_TERRAIN_ENGINE_WITH_HYDRATION_ENGINE
  STOP_LILY_PAD_CONTINENT_READ
  MAKE_LAND_AND_WATER_READ_AS_ONE_WORLD_BODY
  PRESERVE_V2_AND_V3_SOURCE MARKERS
  PRESERVE_CREATE_TERRAIN_LAYER_API_FOR_MAIN_RENDERER

  REQUIRED MARKERS PRESERVED=
...
(function attachPlanetOneTerrainRender(global) {
  ...
  */
  ...
  function createFallbackHydration(uid, land) {
    return `
      <g
        aria-label="internal fallback hydration marriage"
      ...
      >
        ...
        <g aria-label="fallback rivers and basins">
          ...
          <path d="M514 371 C489 412 466 449 454 503 C444 548 416 593 383 636" fill="none" stroke="rgba(92,209,233,0.34)" stroke-width="5" stroke-linecap="round"></path>
          <path d="M455 511 L489 493 L531 501 L560 526 L523 544 L482 540Z" fill="rgba(20,105,135,0.62)"></path>
          <path d="M735 494 L768 478 L809 486 L834 510 L801 528 L766 524Z" fill="rgba(20,105,135,0.52)"></path>
        </g>
      </g>
    `;
  }
  ...
  function createMountainsCanyonsRidges(uid) {
    return `
      ...
      <g aria-label="mountain lift and plateau fracture" filter="url(#${uid}_mountainLift)">
    ...
    return `
      ...
      >
        ...
        <g clip-path="url(#${land.landAll}Clip)" filter="url(#${uid}_ancientCrustTexture)" aria-label="land-contained married terrain crust">
          ...
          ${createMountainsCanyonsRidges(uid)}
          ${createMineralVeins()}
        </g>
      </g>
    `;
  ...
  function createStandaloneSvg(uid) {
    ...
    return `
      <svg class="planet-one-terrain-svg" viewBox="0 0 1000 1000" role="img" aria-label="Planet 1 V4 hydro terrain marriage render">
        <defs>

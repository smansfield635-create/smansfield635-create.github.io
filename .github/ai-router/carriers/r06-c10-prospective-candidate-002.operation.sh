...
python - <<'PY'
import json
router=json.load(open('/tmp/r06-c10-prospective-candidate-002/repository-router-receipt.json'))
preflight=json.load(open('/tmp/r06-c10-prospective-candidate-002/h-earth-preflight-receipt.json'))
assert router['disposition']=='PASS', router
assert preflight['finalDisposition']=='PASS', preflight
PY

...
function scheduleDeferredCapabilityEnhancement(){
  ...
  globalThis.DGB_COMPASS_OPTIONAL_ENHANCEMENT_BOUNDARY=Object.freeze({afterDocumentLoad:true,delayMs:POST_LOAD_ENHANCEMENT_DELAY_MS,firstPaintDependency:false});
}

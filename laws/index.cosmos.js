...
/* NEW FILE */
/* LAWS_COSMOS_HARDENED_v2_IRREGULAR_STARFIELD_DUAL_SPACECRAFT */

/*
  Laws — Autonomous cosmic atmosphere and dual spacecraft engine.
  ...
  Contract:
  - Creates one inert fixed 2D canvas behind the Laws estate.
  - Creates two inert SVG spacecraft with independent randomized cubic Bézier flights.
  - Uses an irregular natural star field rather than geometric star placement.
  ...
  - Does not suspend merely because the Laws compass scene scrolls out of view.
  - Fails independently without changing controller, compositor, crystals,
    interactions, planet, semantic controls, law content, claims, routes, or navigation.
  - Supports partial-initialization rollback and complete destruction.

  Public surfaces:
  - window.DGB_LAWS_COSMOS
  - window.DGB_LAWS_COSMOS_RECEIPT

  Events:
  - DGB_LAWS_REDUCED_MOTION_CHANGE
  - DGB_LAWS_COSMOS_FAILURE
  - DGB_LAWS_COSMOS_READY
  - DGB_LAWS_COSMOS_DESTROYED

  Generated surfaces:
  - #laws-cosmos-runtime-style
  - #laws-cosmos-layer
  - #laws-cosmos-canvas
  ...
  External CSS:
  /laws/index.css v2.3 includes compatibility for the generated surfaces.
*/
...
(() => {
  ...
  const CONTRACT =
    Object.freeze({
      ...
      releaseId:
        "laws-cosmos-hardened-v2-irregular-starfield-dual-spacecraft",
  ...
  const CONFIG =
    Object.freeze({
      ...
      protectedSelectors:
        Object.freeze([
          "[data-laws-threshold-introduction]",
          "[data-laws-orbit-scene]",
          "[data-laws-panel]",
          "[data-laws-scene-field]",
          "[data-laws-objects]",
          ".laws-value-deck",
          ".laws-controller-panel",
          ".laws-discovery__item",
          ".laws-footer"
        ])
    });

  const SPACECRAFT_CONFIGS =
    Object.freeze([
      Object.freeze({
        key:
          "primary",
  ...
  function emitReceipt(
    ...
    if (
      ...
      state.root.dataset
        .lawsCosmosIrregularStarField =
        "true";

      state.root.dataset
        .lawsCosmosDualSpacecraft =
        "true";
    }
  ...
  function controllerReducedMotion() {
    ...
    return Boolean(
      frame.reducedMotion ||
      frame.lawsReducedMotion ||
      frame.rendererReducedMotion ||
      frame.cosmosReducedMotion
    );
  }
    ...
    style.textContent = `
      ...
      #${SPACECRAFT_SECONDARY_ID} {
        ...
        filter:
          ...
          drop-shadow(0 0 9px rgba(168, 140, 255, 0.08));
      }

      .laws-cosmos-spacecraft[data-flying="true"] {
        opacity: 1;
      }

      .laws-cosmos-spacecraft .laws-spacecraft-engine-core {
        animation:
          laws-spacecraft-engine-pulse
          1.45s
          ease-in-out
          infinite
          alternate;
      ...
      .laws-cosmos-spacecraft .laws-spacecraft-running-light {
        animation:
          laws-spacecraft-light-pulse
          2.25s
          ease-in-out
          infinite
          alternate;
      ...
      .laws-cosmos-spacecraft
      .laws-spacecraft-running-light--secondary {
        animation-delay: -1.1s;
      }

      #${SPACECRAFT_SECONDARY_ID} .laws-spacecraft-engine-core {
        animation-duration: 1.12s;
      }

      #${SPACECRAFT_SECONDARY_ID} .laws-spacecraft-running-light {
        animation-duration: 1.72s;
      }

      @keyframes laws-spacecraft-engine-pulse {
        0% {
          opacity: 0.42;
      ...
      @keyframes laws-spacecraft-light-pulse {
        0% {
          opacity: 0.34;
        }
      ...
      @media (max-width: 560px) {
        ...
        #${SPACECRAFT_SECONDARY_ID} {
          ...
          filter:
            ...
            drop-shadow(0 0 6px rgba(168, 140, 255, 0.05));
        }
      }
  ...
  function createLayer() {
    ...
    if (existing) {
      ...
      if (!state.canvas) {
        throw new Error(
          "LAWS_COSMOS_EXISTING_LAYER_CANVAS_MISSING"
        );
      }
      ...
      if (!state.context) {
        throw new Error(
          "LAWS_COSMOS_2D_CONTEXT_UNAVAILABLE"
        );
      }
    ...
    layer.setAttribute(
      "data-laws-cosmos-runtime",
      "true"
    );

    layer.setAttribute(
      "data-laws-cosmos-interactive",
      "false"
    );

    layer.setAttribute(
      "data-laws-cosmos-irregular-star-field",
      "true"
    );

    layer.setAttribute(
      "data-laws-cosmos-dual-spacecraft",
      "true"
    );
  ...
  function createSpacecraft(
    ...
    svg.setAttribute(
      "data-laws-cosmos-spacecraft",
      config.key
    );

    svg.setAttribute(
      "data-laws-cosmos-spacecraft-variant",
      config.variant
    );
  ...
  function spacecraftMarkupPrimary() {
    return `
      <defs>
        <linearGradient
          id="laws-spacecraft-primary-hull-gradient"
          x1="0"
          y1="0"
          x2="1"
          y2="1"
        ...
        <linearGradient
          id="laws-spacecraft-primary-wing-gradient"
          x1="0"
          y1="0"
          x2="1"
          y2="0"
        ...
        <linearGradient
          id="laws-spacecraft-primary-canopy-gradient"
          x1="0"
          y1="0"
          x2="1"
          y2="1"
        ...
        <linearGradient
          id="laws-spacecraft-primary-engine-gradient"
          x1="0"
          y1="0"
          x2="1"
          y2="0"
        ...
        <radialGradient id="laws-spacecraft-primary-light-gradient">
      ...
      <g>
        <path
          class="laws-spacecraft-engine-core"
          d="M41 42 L4 48 L41 54 Z"
          fill="url(#laws-spacecraft-primary-engine-gradient)"
          opacity="0.72"
        />

        <path
          d="M49 34 L17 25 L37 46 L17 69 L55 58 Z"
          fill="url(#laws-spacecraft-primary-wing-gradient)"
        ...
        <path
          d="M43 40
             ...
             C112 75, 70 68, 43 56
             Z"
          fill="url(#laws-spacecraft-primary-hull-gradient)"
        ...
        <path
          d="M102 31
             ...
             L101 43
             Z"
          fill="url(#laws-spacecraft-primary-canopy-gradient)"
        ...
        <circle
          class="laws-spacecraft-running-light"
          cx="204"
          cy="44"
          r="7"
          fill="url(#laws-spacecraft-primary-light-gradient)"
        />

        <circle
          class="laws-spacecraft-running-light laws-spacecraft-running-light--secondary"
          cx="84"
          cy="59"
          r="4.6"
          fill="url(#laws-spacecraft-primary-light-gradient)"
  ...
  function spacecraftMarkupSecondary() {
    return `
      <defs>
        <linearGradient
          id="laws-spacecraft-secondary-hull-gradient"
          x1="0"
          y1="0"
          x2="1"
          y2="1"
        ...
        <linearGradient
          id="laws-spacecraft-secondary-wing-gradient"
          x1="0"
          y1="0"
          x2="1"
          y2="0"
        ...
        <linearGradient
          id="laws-spacecraft-secondary-canopy-gradient"
          x1="0"
          y1="0"
          x2="1"
          y2="1"
        ...
        <linearGradient
          id="laws-spacecraft-secondary-engine-gradient"
          x1="0"
          y1="0"
          x2="1"
          y2="0"
        ...
        <radialGradient id="laws-spacecraft-secondary-light-gradient">
          <stop offset="0%" stop-color="#ffffff" />
      ...
      <g>
        <path
          ...
          fill="url(#laws-spacecraft-secondary-engine-gradient)"
          opacity="0.66"
        />

        <path
          d="M54 38 L20 30 L42 48 L20 66 L58 58 Z"
          fill="url(#laws-spacecraft-secondary-wing-gradient)"
          stroke="rgba(168,140,255,0.32)"
          stroke-width="1"
        />
        ...
        <path
          d="M47 41
             ...
             C113 72, 73 67, 47 55
             Z"
          fill="url(#laws-spacecraft-secondary-hull-gradient)"
        ...
        <path
          d="M100 33
             ...
             L99 44
             Z"
          fill="url(#laws-spacecraft-secondary-canopy-gradient)"
        ...
        <circle
          ...
          cy="45"
          r="5.6"
          fill="url(#laws-spacecraft-secondary-light-gradient)"
        />
  ...
  function initialize() {
    ...
    try {
      ...
      emitReceipt({
        ...
        lastAction:
          "laws-cosmos-initialized-irregular-starfield-dual-spacecraft",
  ...
  function installObservers() {
    ...
    window.addEventListener(
      "DGB_LAWS_CONTROLLER_READY",
      state.boundControllerReady
    );

    window.addEventListener(
      "DGB_LAWS_CONTROLLER_FAILURE",
      state.boundControllerFailure
    );
  ...
  function bindControllerSubscription() {
    ...
    try {
      ...
      if (
        ...
        throw new Error(
          "LAWS_COSMOS_INVALID_CONTROLLER_UNSUBSCRIBE"
        );
      }
  ...
  function applyReducedMotionChange(
    ...
    emitReceipt({
      lastAction:
        "laws-cosmos-reduced-motion-updated",
  ...
  function resumeEnvironment(
    ...
    emitReceipt({
      lastAction:
        `laws-cosmos-environment-resumed:${normalizeReason(reason)}`
    });
  ...
  function suspendEnvironment(
    ...
    if (
      ...
      emitReceipt({
        lastAction:
          `laws-cosmos-environment-suspended:${normalizedReason}`,
  ...
  function start() {
    ...
    emitReceipt({
      lastAction:
        "laws-cosmos-render-loop-started"
    });
  ...
  function stop() {
    ...
    emitReceipt({
      lastAction:
        "laws-cosmos-render-loop-stopped"
    });
  ...
  function drawStaticFrame() {
    ...
    try {
      ...
      emitFailure(
        `LAWS_COSMOS_STATIC_FRAME_FAILURE:${
          error &&
          error.message
            ? error.message
            : String(error)
  ...
  function scheduleNextSpacecraftFlight(
    ...
    emitReceipt({
      lastAction:
        `laws-spacecraft-flight-scheduled:${craft.key}`
    });
  ...
  function launchSpacecraft(
    ...
    emitReceipt({
      lastAction:
        `laws-spacecraft-flight-launched:${craft.key}`
    });
  ...
  function cancelSpacecraftFlight(
    ...
    if (
      ...
      emitReceipt({
        lastAction:
          `laws-spacecraft-flight-cancelled:${craft.key}:${normalizeReason(reason)}`
      });
    }
  ...
  function cancelAllSpacecraftFlights(
    ...
    if (
      ...
      emitReceipt({
        lastAction:
          `laws-spacecraft-flights-cancelled:${normalizeReason(reason)}`
      });
    }
  ...
  function completeSpacecraftFlight(
    ...
    emitReceipt({
      lastAction:
        `laws-spacecraft-flight-completed:${craft.key}`
    });
  }
  ...
  function destroy(
    ...
    const finalReceipt =
      emitReceipt({
        ...
        lastAction:
          `laws-cosmos-destroyed:${normalizeReason(reason)}`,

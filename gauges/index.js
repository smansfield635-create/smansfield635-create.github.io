(() => {
  ...
  const EARTH_STYLE_ID = "dgb-gauges-earth-axis-spin-pass-v1";
  ...
  function createGridSvg() {
    ...
    svg.innerHTML = `
      <defs>
        <clipPath id="earthAxisSpinGridClipDgbV1">
          <circle cx="120" cy="120" r="108"></circle>
        </clipPath>
      </defs>

      <g clip-path="url(#earthAxisSpinGridClipDgbV1)">
  ...
  function createBoundarySvg() {
    ...
    svg.innerHTML = `
      <defs>
        <clipPath id="earthAxisSpinBoundaryClipDgbV1">
          <circle cx="120" cy="120" r="107"></circle>
        </clipPath>
      </defs>

      <g clip-path="url(#earthAxisSpinBoundaryClipDgbV1)">
  ...
  function writeMatrix() {
    ...
    const alphabet = "01_ACK_ST_SCOPE_ROUTE_SOURCE_RUNTIME_VISIBLE_ACCEPTANCE_256_DGB_GEN2_REAL_EARTH_AXIS_SPIN_NATURAL_ROTATION_TILTED_GLOBE_";
    let out = "";
    ...
    const checks = [
      {
        ...
        pass:
          gaugesJs.includes("dgb-gauges-earth-axis-spin-pass-v1") &&
          gaugesJs.includes("data-axis-spin-pass") &&
          gaugesJs.includes("Axis · Natural Spin"),
        fail: "Gauges Earth globe has not received the axis/spin pass.",
  ...
  function renderFeed(diagnostic) {
    ...
    lines.push("CONTROL_PANEL=DEFERRED_UNTIL_SPIN_SYSTEM_PROVEN");

/**
 * H_EARTH_AWARDS_PUBLIC_FACE_PATH_RECOGNITION_v6
...
const EVIDENCE_ID = 'EVIDENCE_H_EARTH_AWARDS_PUBLIC_FACE_PATH_RECOGNITION_v6';
...
export const H_EARTH_AWARDS_PUBLIC_FACE_PATH_RECOGNITION_EVIDENCE = deepFreeze({
  ...
  sourceIdOrPath: 'PR935_AWARDS_PATH_PR1004_TROPHY_STANDARD_VALIDATORS_PR1065_ANCHOR_EVIDENCE_PR1072_MEDIA_RECOVERY_AND_PR1078_SITE_OWNED_MEDIA',
  governingMain: AWARDS_MAIN,
  operationBase: OPERATION_BASE,
  exactTargetPathCount: 1,
  exactRecognizedPathCount: 9,
...
export const H_EARTH_AWARDS_PUBLIC_FACE_PATH_RECOGNITION_NODE = deepFreeze({
  ...
  authoritySource: Object.freeze(['PR935_AUTOMATIC_PREFLIGHT_STOP', 'PR1004_AUTOMATIC_PREFLIGHT_STOPS', 'PR1065_EXPERIENCE_ANCHOR_PREFLIGHT_STOP', 'PR1072_MEDIA_RECOVERY_PREFLIGHT_STOP', 'PR1078_SITE_OWNED_MEDIA_PREFLIGHT_STOP', `EXACT_OPERATION_BASE=${OPERATION_BASE}`]),
  ...
  requiredValidations: Object.freeze(['EXACT_ONE_AWARDS_TARGET_PATH', 'EXACT_RECOGNIZED_AWARDS_MEDIA_PATH', 'EXACT_RECOGNIZED_VALIDATOR_PATHS', 'EXACT_RECOGNIZED_AWARDS_ANCHOR_EVIDENCE_PATHS', 'PREDECESSOR_REGISTRY_IDENTITY_PRESERVED']),
  stoppingBoundaries: Object.freeze(['STOP_ON_PATH_OUTSIDE_EXACT_SCOPE', 'STOP_ON_AUTHORITY_EXPANSION']),
  currentIdentityReferences: Object.freeze([AWARDS_MAIN, OPERATION_BASE, `TARGET_MAIN_BLOB=${TARGET_MAIN_BLOB}`, MEDIA_PATH, `BROWSER_BASE_BLOB=${BROWSER_BASE_BLOB}`, `RUNNER_BASE_BLOB=${RUNNER_BASE_BLOB}`, ANCHOR_EVIDENCE_PATH, ANCHOR_RECEIPT_PATH, RECOVERY_EVIDENCE_PATH, RECOVERY_RECEIPT_PATH]),
...
export function verifyHEarthAwardsPublicFacePathRecognition() {
  ...
  return deepFreeze({
    schema: 'H_EARTH_AWARDS_PUBLIC_FACE_PATH_RECOGNITION_RECEIPT_v6',
    nodeId: NODE_ID,
    evidenceId: EVIDENCE_ID,
    checks,

...
export const H_EARTH_RUN_8B_SUCCESSOR_NEUTRAL_GEOMETRY_PROFILE=freeze({
  ...
  baseSpacingWorldUnits:Math.max(4,Math.min(6,FULL_DETAIL.baseSpacingWorldUnits)),
  refinementSpacingWorldUnits:Math.max(3,Math.min(4,FULL_DETAIL.refinementSpacingWorldUnits)),

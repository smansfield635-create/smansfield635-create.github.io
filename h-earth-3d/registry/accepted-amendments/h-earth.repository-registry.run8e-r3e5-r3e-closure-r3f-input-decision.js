...
const OCCURRENCES = freeze(H_EARTH_RUN_8E_R3E5_PATHS.map((repositoryPath) => freeze({
  ...
  fetchbackStatus: 'R3E5_CORE_CLOSURE_EXECUTION_PENDING',
  occurrenceClass: 'RUN_8E_R3E5_R3E_CLOSURE_R3F_INPUT_DECISION_EXECUTION_OCCURRENCE'
})));
...
export const H_EARTH_RUN_8E_R3E5_EVIDENCE = freeze({
  ...
  evidenceClass: 'R3E5_CLOSURE_AND_R3F_INPUT_DECISION_EXECUTION_PENDING',
  sourceKind: 'REPOSITORY_CONTROL_AND_RECEIPT_RECONCILIATION',
...
export const H_EARTH_RUN_8E_R3E5_NODE = freeze({
  ...
  description: 'Reconciles R3E1 through R3E4, closes R3E when eligible, and issues the bounded input disposition for a separate R3F physical-reference-device and broader-mobile acceptance checkpoint.',
  ...
  authorityClass: 'R3E_CLOSURE_AND_R3F_INPUT_DECISION_EXECUTION_PENDING',
  authorityPosture: 'R3E1_R3E4_PASS_CLOSED_R3E5_EXECUTION_PENDING_R3F_NOT_STARTED_RUN_8E_FAIL_OPEN',
  authoritySource: ['R3E1_PASS_RECEIPT','R3E2_PASS_RECEIPT','R3E3_PASS_RECEIPT','R3E4_PASS_RECEIPT','R3E4_FINAL_EXACT_HEAD_VALIDATION'],
  authorityScope: ['RECONCILE_R3E', 'ISSUE_R3F_INPUT_DECISION', 'PRESERVE_BOUNDARIES'],
  ...
  requiredValidations: ['PREDECESSOR_RECEIPT_IDENTITY','R3E_CLOSURE_LEDGER','R3F_INPUT_DECISION','AUTOMATIC_REGISTRY_PREFLIGHT','EXACT_SCOPE'],
  stoppingBoundaries: ['STOP_BEFORE_PHYSICAL_REFERENCE_DEVICE_AND_BROADER_MOBILE_ACCEPTANCE_R3F'],
  currentIdentityReferences: ['6af68581b5c2d7a2528eedfb34efdfdbbf9aa1b3','2c71944eabc6d4522d934ef2fc4af6a85a38f3b5','e33405c5e7f600e59a6b1103fd856a1d37ca51c5','5c5f1ae06220f88f497dc2b45f4d749679849918','7b2db7ed51a345edea88ad8a1288db4db150201d'],

...
const tools = [
  {
    ...
    applicationClass: 'READ_ONLY_SOURCE_ROUTE_BINDING_HOLD_AND_READINESS_PREFLIGHT',
    route: '/gauges/h-earth/',
    capabilities: ['SOURCE_MARKER_PREFLIGHT', 'ROUTE_REACHABILITY', 'BINDING_MARKER_CHECK', 'HOLD_VISIBILITY', 'READINESS_RECEIPT'],
    runtimeApiKey: null,
    readinessProbe: 'DOCUMENT_DATASET_GAUGES_RECEIPT',
    actions: ['RUN_READ_ONLY_AUDIT'],
    authorityProduced: ['SOURCE_PREFLIGHT_EVIDENCE'],

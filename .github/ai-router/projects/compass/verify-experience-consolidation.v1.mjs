...
check('PURPOSE_COLLAPSED_DEFAULT_DEPTH_PRESERVED',runtime.includes("d.open=false")&&runtime.includes("gen1560CollapsedDefault"),null);
check('SINGLE_TOP_IDENTITY_EVENT',runtime.includes("dataset.identityEvent='single'")&&runtime.includes('dgbIdentityArrival'),null);
...
check('SPATIAL_ECONOMY',runtime.includes('.compass-capability-orbit{min-height:25rem}')&&runtime.includes('@media(max-width:620px){.compass-capability-orbit{min-height:22.5rem}'),null);

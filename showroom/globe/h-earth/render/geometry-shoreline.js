/** H_EARTH_FUNCTIONAL_SHORELINE_GEOMETRY_PROVIDER_GEN329_CONTINUOUS_OCEAN_HANDOFF_v4 */
import {
...
export const H_EARTH_GEOMETRY_SHORELINE_CONTRACT_ID='H_EARTH_FUNCTIONAL_SHORELINE_GEOMETRY_PROVIDER_GEN329_CONTINUOUS_OCEAN_HANDOFF_v4';
export const H_EARTH_FUNCTIONAL_SHORELINE_BANDS=freeze([
  ...
  {bandId:'INNER_SHELF_WATER',innerOffset:-10,outerOffset:-28,materialReference:'H_EARTH_MATERIAL_NEARSHORE_WATER',materialIntent:'INNER_SHELF_WATER'},
  {bandId:'MID_SHELF_WATER',innerOffset:-28,outerOffset:-56,materialReference:'H_EARTH_MATERIAL_NEARSHORE_WATER',materialIntent:'MID_SHELF_WATER'},
  {bandId:'OUTER_SHELF_WATER',innerOffset:-56,outerOffset:-96,materialReference:'H_EARTH_MATERIAL_OPEN_WATER',materialIntent:'OUTER_SHELF_WATER'},
  {bandId:'DEEP_APPROACH_WATER',innerOffset:-96,outerOffset:-160,materialReference:'H_EARTH_MATERIAL_OPEN_WATER',materialIntent:'DEEP_APPROACH_WATER'},
  {bandId:'OPEN_WATER',innerOffset:-160,outerOffset:-320,materialReference:'H_EARTH_MATERIAL_OPEN_WATER',materialIntent:'OPEN_WATER_NEAR_MID_REPRESENTATION'}
]);

const WATER_RENDER_MATERIALS=freeze({
  SHALLOW_WATER:freeze({rgba:[45,160,178,220],transparencyClass:'TRANSLUCENT'}),
  INNER_SHELF_WATER:freeze({rgba:[28,126,166,230],transparencyClass:'TRANSLUCENT'}),
  MID_SHELF_WATER:freeze({rgba:[16,91,139,236],transparencyClass:'TRANSLUCENT'}),
  OUTER_SHELF_WATER:freeze({rgba:[9,61,108,242],transparencyClass:'TRANSLUCENT'}),
  DEEP_APPROACH_WATER:freeze({rgba:[5,36,76,248],transparencyClass:'TRANSLUCENT'}),

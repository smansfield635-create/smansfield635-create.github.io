...
globalThis.CompassIsolatedClone=Object.freeze({version:'gen337-architecture-2',productionMutationAuthorized:false,admission:'ADMITTED_LOCKED',architectureRepair:'CANONICAL_EXISTING_CONSTRUCT_ADOPTION',roomDeclarationCount:roomCount,mirrorlandRouteCount:root?.querySelectorAll('[data-compass-mirrorland-routes] a').length||0});
})();

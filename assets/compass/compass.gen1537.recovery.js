...
const bindHEarth=()=>{
  ...
  document.querySelectorAll('a[href]').forEach(el=>{
    ...
    if(href.includes('raw.githack.com')&&href.includes('/showroom/globe/h-earth/')){
      el.setAttribute('href',H_EARTH_CANONICAL);
    }
  });
};
...
const receipt=Object.freeze({
  ...
  retired:true,
  authoritative:false,
  version:'gen1537-retired-route-shim-track-a-recovery-20260820',
  instrumentMounted:false,
  lowerCarouselPreserved:true,
  clusterGuidanceMounted:false,
  canonicalHEarthDirectBinding:true,
  canonicalHEarthTarget:H_EARTH_CANONICAL,
  capabilityReparenting:false
});

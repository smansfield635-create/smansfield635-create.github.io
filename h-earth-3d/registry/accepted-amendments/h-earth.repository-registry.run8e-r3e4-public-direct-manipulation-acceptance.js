...
const OCCURRENCES = freeze(H_EARTH_RUN_8E_R3E4_PATHS.map((repositoryPath) => freeze({
  ...
  fetchbackStatus: repositoryPath === PASS_RECEIPT_PATH ? 'R3E4_CORE_EXECUTION_PASS_DURABLE_RECEIPT_PENDING' : 'R3E4_CORE_EXECUTION_ARTIFACT_FETCHED_BACK',
  occurrenceClass: 'RUN_8E_R3E4_PUBLIC_DIRECT_MANIPULATION_CORE_PASS_OCCURRENCE'
})));
...
export const H_EARTH_RUN_8E_R3E4_EVIDENCE = freeze({
  ...
  evidenceClass: 'EXECUTED_PUBLIC_ROUTE_DIRECT_MANIPULATION_CORE_PASS_WITH_ARTIFACT_FETCH_BACK',
  ...
  evidenceLimitations: freeze([
    ...
    'DURABLE_R3E4_PASS_RECEIPT_PENDING',
    'RECEIPT_FREE_CLOSURE_CONTROL_RUN_PENDING',
...
export const H_EARTH_RUN_8E_R3E4_NODE = freeze({
  ...
  authorityClass: 'EXECUTED_PUBLIC_DIRECT_MANIPULATION_ACCEPTANCE_CORE_PASS',
  authorityPosture: 'R3E4_CORE_EXECUTION_PASS_DURABLE_RECEIPT_PENDING_UNMERGED_RUN_8E_FAIL_OPEN',
  authoritySource: ['R3E3_PASS_CLOSED', 'R3E3_DURABLE_PASS_RECEIPT', 'R3E4_DECLARED_ACCEPTANCE_MATRIX', 'R3E4_CORE_BROWSER_EXECUTION', 'R3E4_FETCHED_BACK_EVIDENCE_ARTIFACT'],
  ...
  dependencyRelations: [],
  allowedMutationScope: 'R3E4_CONTROL_EXECUTION_EVIDENCE_SCOPE_WITH_CORE_PASS_DURABLE_FAILED_ATTEMPTS_AND_RESERVED_PASS_RECEIPT',
  ...
  lifecycleStatus: 'CORE_EXECUTION_PASS_DURABLE_RECEIPT_PENDING',
  unresolvedFields: ['RECEIPT_FREE_CLOSURE_CONTROL_RUN', 'DURABLE_PASS_RECEIPT', 'FINAL_EXACT_HEAD_REVALIDATION']
});

...
if(!aRoot||!bRoot)throw new Error('USAGE: node observer-scale-ab.performance.mjs <A_ROOT> <B_ROOT>');
...
const receipt={receiptType:'H_EARTH_OBSERVER_SCALE_AB_PERFORMANCE_STATIC_v1',A:await measure(aRoot,'A_8U'),B:await measure(bRoot,'B_4U'),productMutation:false};

(()=>{
'use strict';
const GLOBAL='DGB_COMPASS_READINESS_CONTEXT_V4';
...
style.id='compass-readiness-gen1793-continuity';
style.textContent=`
...
function wireCarousel(type){
  ...
  if(slides.length<1||tabs.length!==slides.length||!title||!ordinal||!viewport)throw new Error(`COMPASS_${type.toUpperCase()}_STATIC_CAROUSEL_INVALID`);

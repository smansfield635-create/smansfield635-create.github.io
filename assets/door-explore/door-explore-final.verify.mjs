...
assert.ok(home.includes('pointerdown')&&home.includes('pointermove')&&home.includes('ArrowLeft')&&home.includes('ArrowRight'));
...
console.log(JSON.stringify({result:'PASS_SPATIAL_CLOSED',cards:11,cycles:5,door:6,explore:5}));

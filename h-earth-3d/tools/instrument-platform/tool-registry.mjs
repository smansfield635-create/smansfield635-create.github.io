...
const tools = [
  ...
  {
    toolId: 'IMI_EMPIRICAL_PLATFORM',
    displayName: 'IMI Empirical Platform',
    applicationClass: 'REPOSITORY_INTEGRATED_INTRINSIC_MANEUVERABILITY_INDEX_ROUTE_SCORING_AND_EMPIRICAL_PORTFOLIO_RECEIPT_ENGINE',
    route: '/h-earth-3d/tools/imi-empirical-platform/',
    capabilities: [
      'ROUTE_SPECIFIC_IMI_SCORING',
      'CONSTRAINT_SEVERITY_SCORING',
      'WEAKEST_FACTOR_DIAGNOSIS',
      'HARD_COLLAPSE_DETECTION',
      'UNEVALUABLE_MISSINGNESS_HANDLING',
      'ADDITIVE_COMPARATOR_OUTPUT',
      'STUDY_RECEIPT_GENERATION',
      'PORTFOLIO_REGISTRY_APPEND_ENTRY'
    ],
    runtimeApiKey: 'IMI_EMPIRICAL_PLATFORM_API',
    readinessProbe: 'GLOBAL_IMI_EMPIRICAL_PLATFORM_API',
    actions: ['RUN_ROUTE_STUDY', 'GENERATE_STUDY_RECEIPT', 'APPEND_PORTFOLIO_ENTRY'],
    authorityProduced: ['IMI_STUDY_RECEIPT', 'IMI_EMPIRICAL_PORTFOLIO_ENTRY', 'ROUTE_LEVEL_EVIDENCE_SUMMARY'],
    prohibitedMutations: ['ROUTE_CERTIFICATION', 'DATASET_CERTIFICATION', 'PUBLIC_RELEASE', 'PRODUCTION_RELEASE', 'FINAL_SCALE_ADMISSION']
  }
];

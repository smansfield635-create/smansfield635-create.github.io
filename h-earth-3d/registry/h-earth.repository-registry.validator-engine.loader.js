...
// and the cumulative Run 8E-R2 package registry overlay through R2E.
import registryFacade from './accepted-amendments/h-earth.repository-registry.run8e-r2-package-scope.js';
import {
  deepFreeze,

#!/usr/bin/env node
import {verifyAssessment,normalizeSignal,REQUIRED,GAP_ID} from './workflow-lifecycle-continuity-verifier.v1.mjs';
const head='d906c334fee88d15886df281b677c60ec4fec163';

...
check('FLAGSHIP_HERO_ARCHITECTURE',flagship.includes('COMPASS Gen1533 flagship spatial presentation')&&flagship.includes('.compass-instrument__grid')&&flagship.includes('.compass-scene')&&flagship.includes('perspective:1500px'),'one coherent spatial hero');
...
check('NINETEEN_ROOMS',(html.match(/data-room-id="/g)||[]).length===19,'nineteen room declarations');

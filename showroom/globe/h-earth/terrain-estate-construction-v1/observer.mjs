...
export function buildHEarthMapWideEnvironmentPreviewObserverReceipt(meshStatistics = null, waterStatistics = null) {
  ...
  const checks = {
    ...
    reservoirAtSmallLakeScale: H_EARTH_MAP_WIDE_ENVIRONMENT_REDEVELOPMENT_HYDROLOGY.reservoir.radius.x >= 48 && H_EARTH_MAP_WIDE_ENVIRONMENT_REDEVELOPMENT_HYDROLOGY.reservoir.radius.z >= 32,
    ...
    fullBeachPresent: beach.valid === true && (beach.coastline?.beachWeight ?? 0) > 0.5 && beach.coastline?.fullBeachConstructed === true,

...
(() => {
  ...
  const loadStyle = (href, marker) => { if (document.querySelector(`link[${marker}]`)) return; const link = document.createElement("link"); link.rel = "stylesheet"; link.href = href; link.setAttribute(marker, "true"); document.head.append(link); };
  load("/laws/index.mobile-background-tabs.core.js?v=LAWS_ROOT_ROLODEX_RESPONSIVE_CONTINUITY_V5_ORBIT_CUSTODY", "data-laws-responsive-core")
    .then(() => load("/laws/index.destination-carousel.js?v=LAWS_DESTINATION_CAROUSEL_RUNTIME_V9_METHODS_REFERENCE_PORT_20260816A", "data-laws-destination-carousel-runtime"))

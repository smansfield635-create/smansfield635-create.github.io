...
// Run 8E-R1 profiling and material-ledger overlays, and the complete Run 8E-R2
// package scope through registry custody checkpoint R2E.
import registryFacade from './accepted-amendments/h-earth.repository-registry.run8e-r2-complete-package-scope.js';
import {
  deepFreeze,

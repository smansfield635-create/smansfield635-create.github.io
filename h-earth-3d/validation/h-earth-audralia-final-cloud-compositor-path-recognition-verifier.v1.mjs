...
const BASE_HEAD = '5644116fd0bcfccc53261ecdfdd064051d938d68';
...
const VERIFIER_PATH = 'h-earth-3d/validation/h-earth-audralia-final-cloud-compositor-path-recognition-verifier.v1.mjs';
...
function main() {
  ...
  for (const token of [
    VERIFIER_PATH,
    'agent/audralia-final-cloud-compositor-registration-gen1713-20260825',
    'audralia-final-cloud-compositor-registration-builder',
    'audralia-final-cloud-compositor-registration-fresh-verifier',
    'audralia-final-cloud-compositor-registration-fingerprint-match',
    'contents: read'

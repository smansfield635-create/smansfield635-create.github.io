/* /assets/audralia.land.render.js
   AUDRALIA_G2_LAND_ENGINE_TNT_v1
...
(function bindAudraliaLandRenderEngine(global) {
  ...
  const VERSION = "AUDRALIA_G2_LAND_ENGINE_TNT_v1";
  ...
  const REGION_DEFINITIONS = [
    {
      ...
      summit: "Character",
      role: "origin ridge / exposed ancient stone",
      lon: -122,
      lat: 23,
      rx: 36,
      ry: 25,
    ...
    },
    {
      ...
      summit: "Structure",
      role: "stable plateau / mature foundation land",
      lon: -18,
      lat: 4,
      rx: 43,
      ry: 25,
    ...
    },
    {
      ...
      summit: "Stability",
      role: "broad habitable shelf / temperate coast",
      lon: 154,
      lat: -11,
      rx: 38,
      ry: 23,
    ...
    },
    {
      ...
      summit: "Peace",
      role: "protected basin / sheltered land pocket",
      lon: -54,
      lat: -47,
      rx: 31,
      ry: 21,
    ...
    },
    {
      ...
      summit: "Joy",
      role: "bright archipelago / warm island land",
      lon: -148,
      lat: 31,
      rx: 33,
      ry: 20,
    ...
    },
    {
      ...
      summit: "Dignity",
      role: "elevated mineral crownland / weathered ridge",
      lon: 139,
      lat: 36,
      rx: 34,
      ry: 21,
    ...
    },
    {
      ...
      summit: "Free Will",
      role: "frontier belt / wild transitional terrain",
      lon: 18,
      lat: 43,
      rx: 37,
      ry: 22,
    ...
    },
    {
      ...
      summit: "Love",
      role: "convergence heartland / terrain systems meeting",
      lon: 84,
      lat: -14,
      rx: 68,
      ry: 39,
    ...
    },
    {
      ...
      summit: "Balance",
      role: "ancient southern basin support",
      lon: 96,
      lat: -58,
      rx: 45,
      ry: 13,
    ...
    },
    {
      ...
      summit: "Joy",
      role: "equatorial island chain support",
      lon: -10,
      lat: -4,
      rx: 23,
      ry: 9,
    ...
    },
    {
      ...
      summit: "Stability",
      role: "western seam-safe littoral support",
      lon: -174,
      lat: -15,
      rx: 17,
      ry: 32,
    ...
    },
    {
      ...
      summit: "Stability",
      role: "eastern seam-safe littoral support",
      lon: 174,
      lat: -15,
      rx: 17,
      ry: 32,
  ...
  const RIDGE_DEFINITIONS = [
    { key: "love_spine", lon: 82, lat: -7, rx: 9, ry: 62, rot: 72, power: 0.82 },
    { key: "southern_spine", lon: 119, lat: -32, rx: 8, ry: 36, rot: 82, power: 0.56 },
    { key: "character_spine", lon: -108, lat: 20, rx: 7, ry: 32, rot: 108, power: 0.72 },
    { key: "dignity_crown", lon: 149, lat: 31, rx: 7, ry: 29, rot: 72, power: 0.76 },
    { key: "structure_fold", lon: -10, lat: 4, rx: 7, ry: 28, rot: 104, power: 0.54 },
    { key: "free_will_fold", lon: 20, lat: 42, rx: 6, ry: 34, rot: 82, power: 0.50 }
  ];
  ...
  function sampleLand(lonInput, latInput, context) {
    const lon = normalizeLon(Number(lonInput) || 0);
    ...
    const coastlinePressure = clamp(1 - smoothstep(0.018, 0.135, Math.abs(terrain)), 0, 1);

    const regionRidge = ridgeField(lon, lat);
    ...
    const summitRegion = region.key;
    const summitName = region.summit;
    ...
    return {
      ...
      coastlinePressure: clamp(coastlinePressure * region.coastlineBase, 0, 1),
      elevation,
      ridge,
      basin,
      mineral,

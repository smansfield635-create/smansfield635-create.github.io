/** H_EARTH_SUCCESSOR_TERRAIN_NEAR_REPRESENTATION_RUN_8B_v2 */
import {
...
export const H_EARTH_RUN_8B_SUCCESSOR_NEUTRAL_GEOMETRY_CONTRACT_ID='H_EARTH_SUCCESSOR_TERRAIN_NEAR_REPRESENTATION_RUN_8B_v2';
...
const NEAR_DOMAIN=freeze({xMinimum:-320,xMaximum:320,zMinimum:-360,zMaximum:96});
...
export const H_EARTH_RUN_8B_Z_BANDS=freeze([
  {bandId:'NEAR_INLAND_RELIEF',zMinimum:-360,zMaximum:-220},
  {bandId:'NEAR_COASTAL_CONTINUITY',zMinimum:-220,zMaximum:96}
]);
...
export function getHEarthRun8BSuccessorSamplingAxes(){
  return freeze({xValues:axis(NEAR_DOMAIN.xMinimum,NEAR_DOMAIN.xMaximum,H_EARTH_RUN_8B_SUCCESSOR_NEUTRAL_GEOMETRY_PROFILE.baseSpacingWorldUnits),zValues:axis(NEAR_DOMAIN.zMinimum,NEAR_DOMAIN.zMaximum,H_EARTH_RUN_8B_SUCCESSOR_NEUTRAL_GEOMETRY_PROFILE.baseSpacingWorldUnits)});
}
...
export function constructHEarthRun8BSuccessorTerrainAndMountain(){
  ...
  const construction=constructHEarthTriangleMesh({
    ...
    semanticRole:'WORLD_MANIFOLD_NEAR_TERRAIN_REPRESENTATION',
    ...
    source:{sourceType:'G_WORLD_NEAR_REPRESENTATION',worldDomainContractId:H_EARTH_WORLD_MANIFOLD_DOMAIN_CONTRACT_ID,topologySourceId:H_EARTH_WORLD_MANIFOLD_TOPOLOGY_SOURCE_ID,successorTerrainFieldContractId:H_EARTH_RUN_8B_SUCCESSOR_TERRAIN_FIELD_CONTRACT_ID},
    attributes:{rowCount:topology.rowCount,columnCount:topology.columnCount,xValues:topology.xValues,zValues:topology.zValues},
    metadata:{providerContractId:H_EARTH_RUN_8B_SUCCESSOR_NEUTRAL_GEOMETRY_CONTRACT_ID,representationClass:'NEAR',worldDomainContractId:H_EARTH_WORLD_MANIFOLD_DOMAIN_CONTRACT_ID,topologySourceId:H_EARTH_WORLD_MANIFOLD_TOPOLOGY_SOURCE_ID,sourceAuthority:'DERIVED_REPRESENTATION_ONLY',independentGeographyAuthority:false,hardWorldTerminalAuthority:false,zBandVertexCounts:topology.zBandVertexCounts,sharedEdgePairCount:sharedEdges.sharedEdgePairCount,formerBoundaryContinuityEligible:continuity.eligible,legacyProxyContractId:H_EARTH_GEOMETRY_DISTANT_CONTEXT_CONTRACT_ID,legacyProxyMutated:false,admitted:false,WestAdmissionExecuted:false,packet002TransferExecuted:false,rendererMaterialized:false,publicRouteMutated:false}
  });

...
function normalizeHEarthInspectGroundString(value, fallback = '') {
if (typeof value !== 'string') return fallback;
const trimmed = value.trim();
return trimmed.length > 0 ? trimmed : fallback;
}

function normalizeHEarthInspectGroundTargets(targets = []) {
...
And what about in reference to this file directly and what we should do moving forward

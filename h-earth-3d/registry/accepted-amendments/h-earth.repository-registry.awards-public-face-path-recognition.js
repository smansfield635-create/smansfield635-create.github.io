...
export const H_EARTH_AWARDS_PUBLIC_FACE_PATH_RECOGNITION_NODE = deepFreeze({
  ...
  description: 'Read-only recognition of the promoted Awards public face, its Trophy Standard verifier paths, and its bounded experience-anchor evidence paths for automatic preflight resolution.',

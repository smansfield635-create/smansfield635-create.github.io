...
const PASS_RECEIPT_BLOB = 'd8b5f3b4626014af6b62362d1bac26e120f50e60';
...
const OCCURRENCES = freeze(H_EARTH_RUN_8E_R3F1_PATHS.map((repositoryPath) => freeze({
  ...
  commitSha: null,
  path: repositoryPath,
  gitBlobSha: repositoryPath === PASS_RECEIPT_PATH ? PASS_RECEIPT_BLOB : null,
  contentSha256: null,
  byteCount: null,
  existenceStatus: 'PRESENT',
  fetchbackStatus: repositoryPath === PASS_RECEIPT_PATH ? 'R3F1_DURABLE_PASS_RECEIPT_FETCHED_BACK' : 'R3F1_PASS_CLOSED_EVIDENCE_FETCHED_BACK',
...
export const H_EARTH_RUN_8E_R3F1_EVIDENCE = freeze({
  ...
  evidenceClass: 'R3F1_PROTOCOL_AND_EVIDENCE_INTAKE_AUTHORITY_PASS_CLOSED_WITH_DURABLE_RECEIPT',
  ...
  evidenceMetadata: freeze({
    ...
    closureControlHead: '55fec155a28d7aabd29d7692d84d39cda1cd5059',
    closureControlWorkflowRun: 30314682014,
    closureControlWorkflowJob: 90137636672,
    closureControlArtifactId: 8671700660,
    closureControlArtifactDigest: 'sha256:2bbbe3eac3ad202e9d07fe41739e1c57a8c8b1718e3c82d264b778b53460570a',
    closureControlArtifactFetchBackVerified: true,
    closureControlAutomaticRegistryPreflightRun: 30314681951,
    passReceiptPresentDuringClosureControl: false,
    durablePassReceiptPath: PASS_RECEIPT_PATH,
    durablePassReceiptGitBlob: PASS_RECEIPT_BLOB,
    durablePassReceiptStatus: 'RUN_8E_R3F1_PASS_CLOSED'
  }),
...
export const H_EARTH_RUN_8E_R3F1_NODE = freeze({
  ...
  authorityPosture: 'R3F1_PASS_CLOSED_FINAL_EXACT_HEAD_REVALIDATION_PENDING_R3F2_NOT_STARTED_RUN_8E_FAIL_OPEN',
  authoritySource: ['R3E5_PASS_RECEIPT', 'R3E5_FINAL_EXACT_HEAD_VALIDATION', 'R3F_INPUT_DECISION', 'R3F1_CORE_PROTOCOL_EXECUTION', 'R3F1_FETCHED_BACK_ARTIFACT', 'R3F1_RECEIPT_FREE_CLOSURE_CONTROL_PASS', 'R3F1_DURABLE_PASS_RECEIPT'],
  ...
  currentIdentityReferences: ['548672ae99cd406805f0c8ca576cc650baf7ed18','ddd7fbf4065abbfb51e222c3500328b5b7aaab00','f923fa8127c56b1304717e86cfbc44e746d80cc8','08c4b9558d995acbc9ba1ff59990b8bc65d4a00d','30314464717','90136979082','8671621390','55fec155a28d7aabd29d7692d84d39cda1cd5059','30314682014','90137636672','8671700660',PASS_RECEIPT_BLOB],
  lifecycleStatus: 'PASS_CLOSED_FINAL_EXACT_HEAD_REVALIDATION_PENDING',
  unresolvedFields: ['FINAL_EXACT_HEAD_VALIDATION']
});

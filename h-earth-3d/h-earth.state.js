...
export const H_EARTH_STATE_PRIOR_BASELINE = Object.freeze({
  sourceFile: '/h-earth-3d/h-earth.state.js',
...
export const H_EARTH_STATE_CONTRACT = Object.freeze({
  contractId: H_EARTH_STATE_CONTRACT_ID,
  renewsSourceFile: '/h-earth-3d/h-earth.state.js',
  ...
  directRuntimeKernelDependencies: Object.freeze([
    Object.freeze({
      file: '/h-earth-3d/runtime/h-earth.state-classification.js',
    ...
    Object.freeze({
      file: '/h-earth-3d/runtime/h-earth.deterministic-runtime.js',

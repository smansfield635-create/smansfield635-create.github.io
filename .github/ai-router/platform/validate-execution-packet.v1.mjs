...
if (packet.mode !== 'DIRECT_CONSTRUCTION') fail('EXECUTION_PACKET_MODE_INVALID');
...
for (const required of ['CANDIDATE_READY', 'EXECUTION_TOOLING_BLOCKED', 'DIRECT_CONSTRUCTION_TIMEOUT', 'GOVERNING_HEAD_OVERLAP']) {

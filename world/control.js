...
export function createControlSystem() {
  ...
  function nudgeRotation(deltaYaw = 0, deltaPitch = 0) {
    if (isFiniteNumber(deltaYaw)) yawVelocity += deltaYaw;
    if (isFiniteNumber(deltaPitch)) pitchVelocity += deltaPitch;
  }

...
for(const literal of [
  ...
  CANDIDATE,
  `https://cdn.jsdelivr.net/gh/smansfield635-create/smansfield635-create.github.io@${CANDIDATE}/`,
  "publicMethodsMutation:false",
  "liveMethodsRouteMutation:false",
  "r9Execution:false",
  "controllingCandidateMutation:false"
]) if(!carrier.includes(literal)) fail('CARRIER_REQUIRED_LITERAL_MISSING');

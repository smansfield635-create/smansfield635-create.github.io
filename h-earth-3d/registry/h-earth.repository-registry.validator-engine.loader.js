 ...
 * additive facade needed for HC02 Page Excellence execution-carrier and
...
} from './accepted-amendments/h-earth.repository-registry.hc02-page-excellence-execution-carrier-scope.js';
import {
  deepFreeze
...
export function loadHEarthRepositoryRegistryValidatorDependencies() {
  ...
  return deepFreeze({
    ...base,
    loaderId:
      'H_EARTH_REPOSITORY_REGISTRY_VALIDATOR_DEPENDENCY_LOADER_v8_HC02_PAGE_EXCELLENCE_EXECUTION_CARRIER_SUCCESSOR',
    registryFacade,
    registryInstance,
    discovery,
    identityChecks: deepFreeze({
      ...
      hc02PageExcellenceExecutionCarrierScope:

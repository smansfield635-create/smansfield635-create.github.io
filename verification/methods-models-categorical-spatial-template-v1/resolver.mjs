...
const CAMERA_PRESETS = Object.freeze({
  desktop: Object.freeze({
    overview: Object.freeze({ depth: 520, rotateX: -8, rotateY: 10, scale: 0.82 }),
  ...
  tablet: Object.freeze({
    overview: Object.freeze({ depth: 470, rotateX: -7, rotateY: 9, scale: 0.76 }),
  ...
  mobile: Object.freeze({
    overview: Object.freeze({ depth: 430, rotateX: -6, rotateY: 7, scale: 0.62 }),
...
export function resolveSceneState({ registry, nativeState, cameraMode = "overview", inspectionOpen = false, viewport }) {
  ...
  const target = vectorAdd(targetBase, lensVector);
  ...
  const nodes = registry.descriptors.map(descriptor => {
    ...
    return Object.freeze({
      ...
      detailClass,
      visible,
      position: vectorAdd(descriptor.fieldPosition, descriptor.lensRelation[native.lensId] || [0, 0, 0]),

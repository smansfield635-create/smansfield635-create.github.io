...
check('CANONICAL_PHASE4_CONSUMER',house.includes("MIRROR_MANOR_GOTHIC_ARCHITECTURAL_DETAIL_PHASE4_LIVED_IN_v1")&&house.includes("import('/assets/manor-blueprint/manor.estate.gothic-detail-phase4.mjs')"));
check('PHASE3_PARENT_PRESERVED',house.includes("MIRROR_MANOR_GOTHIC_ARCHITECTURAL_DETAIL_PHASE4_LIVED_IN_v1"));
...
const receipt={schema:'MIRROR_MANOR_CAROUSEL_FINAL_FRAMING_RECEIPT_v2',failures,result:failures.length?'FAIL_CLOSED':'PASS_CLOSED'};

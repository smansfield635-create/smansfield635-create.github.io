...
// Run 8E-R1 profiler, and executed R1 repository-package evidence overlays.
import registryFacade from './accepted-amendments/h-earth.repository-registry.run8e-r1-repository-package-scope.js';
import {
  deepFreeze,

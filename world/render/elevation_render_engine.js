// /world/render/elevation_render_engine.js
// MODE: RENDER EXTENSION CONTRACT RENEWAL
// STATUS: ELEVATION FACTOR AUTHORITY v1
// ROLE:
// - read planet-engine-facing elevation fields only
// - classify upward terrain emphasis only
...
function normalizePacket(packet, fallbackColor, fallbackRadiusPx) {
  ...
  return Object.freeze({
    contractId: "ELEVATION_RENDER_CONTRACT_v1",
    engineKey: "elevation",
    layer: normalizeString(packet.layer, "elevation"),
    category: normalizeString(packet.category, "ELEVATION"),
    subCategory: normalizeString(packet.subCategory, "NONE"),

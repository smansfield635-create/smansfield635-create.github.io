...
.laws-source-files{display:grid;gap:.55rem;padding:0;list-style:none}.laws-source-files li{display:grid;gap:.25rem;padding:.7rem;border:1px solid rgba(157,190,240,.12);border-radius:.7rem}.laws-source-files code{color:rgba(208,225,251,.7);font-size:.72rem}

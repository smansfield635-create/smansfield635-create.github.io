...
[534,1160],[502,1090],[484,1008],[484,920],[498,832],[528,748],[570,672],[624,604],[684,544],[744,490],[804,426],[866,350],[932,278],[1006,218],[1082,178],[1140,158],[1150,154],[1150,-220],[118,-220],[118,148],[180,210],[238,282],[290,362],[336,452],[374,546],[408,636],[438,720],[466,804],[492,894],[514,992],[528,1070]
];

const WEST_SHORE=[
[498,1086],[476,1014],[468,938],[476,858],[500,780],[534,704],[578,634],[624,570],[666,506],[700,438],[720,368],[720,300],[698,234],[654,176],[598,132],[534,102],[464,74],[398,42],[334,10]
];

const EAST_SHORE=[
[564,1084],[584,1010],[618,938],[664,868],[720,800],[786,732],[852,662],[920,586],[988,504],[1054,428],[1116,370],[1150,342]
];

const HARBOR_COVE=[
[492,956],[514,916],[552,890],[598,890],[636,912],[652,950],[646,994],[616,1034],[572,1052],[526,1048],[496,1018],[488,984]
];

const BASIN_WATER=[
[472,592],[500,550],[546,514],[608,496],[672,504],[724,536],[754,582],[754,632],[728,678],[678,714],[614,732],[552,724],[502,696],[476,648]
];

const BASIN_SHELF=[
[468,624],[502,574],[556,536],[622,520],[688,530],[742,566],[770,618],[764,674],[730,724],[670,758],[600,770],[534,756],[486,724],[462,674]
];

const INNER_INLET=[
[604,904],[652,870],[708,820],[768,754],[826,678],[880,596],[934,514],[990,442],[1048,384],[1104,340],[1150,308]
];

const NORTH_FOG=[
[118,-36],[280,-76],[520,-108],[798,-104],[1038,-64],[1150,-8],[1150,258],[118,258]
];

const MOUNTAIN_FOOTHILLS=[
[540,546],[584,490],[642,434],[714,380],[794,330],[876,296],[954,282],[1020,296],[1064,334],[1078,392],[1052,452],[992,502],[914,532],[828,548],[736,554],[642,554]
];

const RIDGE_SHADOW=[
[560,590],[616,534],[684,484],[762,438],[846,402],[930,386],[1008,392],[1062,420],[1084,464],[1068,510],[1012,546],[934,568],[846,580],[752,584],[654,586]
];

const WEST_SHELF=[
[458,1016],[444,946],[450,872],[472,796],[506,722],[550,654],[598,594],[640,536],[668,474],[678,410],[666,348],[636,288],[588,230],[530,182],[468,148],[406,120]
];

const EAST_SHELF=[
[614,988],[658,922],[714,854],[774,786],[838,716],[904,638],[970,556],[1038,478],[1102,412],[1150,372]
];

const HILL_PATCH_A=[
[468,942],[510,900],[574,880],[636,890],[682,926],[688,970],[652,1004],[594,1022],[530,1018],[482,990]
];

const HILL_PATCH_B=[
[390,798],[432,748],[494,714],[566,706],[630,726],[662,764],[650,808],[598,842],[524,856],[450,844]
];
...
ctx.strokeStyle=isSelected?"rgba(255,244,220,0.92)":isActive?"rgba(255,232,188,0.72)":"rgba(214,236,248,0.62)";
ctx.lineWidth=3;
ctx.stroke();
}
}

...
/* SHOWROOM_MIRRORLAND_COMPACT_GAUGE_DASHBOARD_TNT_v4 */

(() => {
  "use strict";

  const CONTRACT = Object.freeze({
    id: "SHOWROOM_MIRRORLAND_COMPACT_GAUGE_DASHBOARD_TNT_v4",
    version: "4.0.0",
    scope: "/showroom/",
    ownership: Object.freeze({
      owns: Object.freeze([
        ...
        "gauge receipts",
        "gauge validation status"
      ]),
      excludes: Object.freeze([
        "controller validation output",
  ...
  function getReceiptOutput() {
    ...
    if (output instanceof HTMLElement) {
      ...
      /*
        Remove any rendered receipt content retained by an older gauges
        build. Gauge receipts are stored as nonvisual dataset telemetry.
      */
      output.textContent =
        "";
  ...
  function publishReceipt(
    ...
    if (output) {
      output.dataset.showroomGaugesReceipt =
        serialized;

      output.dataset.showroomGaugesReceiptState =
        type;
    }
  ...
  function validateInformationGroup(
    ...
    for (
      ...
      if (
        ...
        violations.push({
          code:
            "INFORMATION_ARIA_CONTROLS_INVALID",
  ...
  function publishValidation() {
    ...
    if (root) {
      root.dataset.showroomGaugesValidation =
        result.valid
          ? "PASS"
          : "FAIL";
    }
  ...
  function findGaugeDetail(
    dashboard,
    gaugeId
  ) {
    return query(
      `${SELECTORS.detail}[data-gauge-detail-id="${escapeIdentifier(
        gaugeId
      )}"]`,
      dashboard
    );
  ...
  function updateDashboardState(
    ...
    dashboard.dataset.gaugeDashboardState =
      "interactive";

    dashboard.dataset.activeGaugeId =
      gaugeId;
  ...
  function initializeDashboard(
    ...
    const initialGaugeId =
      normalize(
        initialGauge.dataset
          .gaugeId
      );
    ...
    for (
      ...
      gauge.dataset.showroomGaugeBound =
        "true";
  ...
  function getInformationGroupId(
    group
  ) {
    return (
      normalize(
  ...
  function findInformationPanel(
    group,
    panelId
  ) {
    return query(
      `${SELECTORS.informationPanel}[data-information-panel-id="${escapeIdentifier(
        panelId
      )}"]`,
      group
    );
  ...
  function updateInformationState(
    ...
    group.dataset.showroomInformationState =
      "interactive";

    group.dataset.activeInformationPanel =
      panelId;
    ...
    if (root) {
      root.dataset.showroomActiveInformationTab =
        panelId;
    }

    const groupId =
      getInformationGroupId(
        group
      );
    ...
    document.dispatchEvent(
      new CustomEvent(
        "showroom:information-selection",
        {
          detail: {
            groupId,
            panelId,
  ...
  function initializeInformationGroup(
    ...
    for (
      ...
      if (
        tab.dataset
          .showroomInformationTabBound ===
        "true"
      ) {
        continue;
      }

      tab.dataset.showroomInformationTabBound =
        "true";
  ...
  function findFront(
    ...
    return (
      ...
      query(
        `${SELECTORS.front}[data-showroom-gauge-set="${escapeIdentifier(
          frontId
        )}"]`
      )
    );
  ...
  function setSupportingFront(
    ...
    if (
      ...
      for (
        ...
        front.dataset.showroomFrontState =
          active
            ? "active"
            : "inactive";
      ...
      target.dataset.showroomFrontState =
        "active";
  ...
  function revealAllSupportingFronts(
    options = {}
  ) {
    const {
      publish = true,
  ...
  function updateWindowGaugeState() {
    ...
    const normalizedState =
      windowState.toLowerCase() ===
      "open"
        ? "open"
        : "closed";

    gauge.dataset.gaugeState =
      normalizedState;
  ...
  function bindIntegrationEvents() {
    ...
    document.addEventListener(
      "showroom:front-reset-request",
      () => {
        revealAllSupportingFronts({
          source:
            "front-reset-request-event"
        });
      }
    );
  ...
  function initialize() {
    ...
    root.dataset.showroomGaugesState =
      "interactive";

    root.dataset.showroomGaugesReady =
      "true";
  ...
  const API =
    Object.freeze({
      ...
      selectGauge(
        ...
        const dashboard =
          query(
            `${SELECTORS.dashboard}[data-gauge-dashboard-id="${escapeIdentifier(
              dashboardId
            )}"]`
          ) ||
          document.getElementById(
      ...
      selectInformation(
        ...
        const group =
          query(
            `${SELECTORS.informationTabs}[data-information-tabs-id="${escapeIdentifier(
              groupId
            )}"]`
          ) ||
          document.getElementById(

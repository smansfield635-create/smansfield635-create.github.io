...
const SUCCESSOR_OPERATION='AUDRALIA_HOOK5_GESTURE_READABLE_ERROR_RECEIPT_20260828_004';
const SUCCESSOR_GENERATION=1799;
...
function exportFailure(error){
  const firstFailure=Object.freeze({
    ...
    predecessorOperationId:'AUDRALIA_HOOK5_GESTURE_RESPONSE_DIAGNOSTIC_20260828_005',
    predecessorGeneration:1792,
  ...
  fs.writeFileSync('/tmp/audralia-gesture-response-receipt.json',`${JSON.stringify(firstFailure,null,2)}\n`);

...
check('PRESERVED_COMPASS_STATE_PRESENT', html.includes('data-preserved-compass-state') && controller.includes('preservedCompassState'), 'persistent orientation state');

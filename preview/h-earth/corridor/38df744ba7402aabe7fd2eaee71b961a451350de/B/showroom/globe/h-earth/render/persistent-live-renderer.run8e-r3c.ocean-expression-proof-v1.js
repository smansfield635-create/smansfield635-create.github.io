...
export const H_EARTH_GRATITUDE_REGION_CP2_PRESENTATION_PROFILE_ID =
  'H_EARTH_OCEAN_GRAPHICAL_EXPRESSION_PROOF_PRESENTATION_v1';
...
export function createHEarthRun8ER3CPersistentRenderer({ canvas, width = 640, height = 360 } = {}) {
  ...
  function initialize(packet) {
    ...
    resources.uniforms = {
      ...
      distanceDesaturationStrength: uniform(resources.geometryProgram, 'uDistanceDesaturationStrength'), oceanProofPhase: uniform(resources.geometryProgram, 'uOceanProofPhase'), depth: uniform(resources.depthProgram, 'uDepth')
    };
  ...
  function getResourceReceipt() {
    ...
    return {
      ...
      presentationProfile: {
        oceanGraphicalExpressionProof: true, continuousWaterExpression: true, multiScaleDeterministicSurface: true,

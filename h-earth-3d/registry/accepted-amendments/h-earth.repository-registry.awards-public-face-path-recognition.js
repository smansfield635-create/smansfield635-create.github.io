...
export const H_EARTH_AWARDS_PUBLIC_FACE_PATH_RECOGNITION_NODE = deepFreeze({
  ...
  authorityLimitations: Object.freeze(['NO_AWARDS_PRODUCT_MUTATION', 'NO_MEDIA_CONTENT_MUTATION_AUTHORITY', 'NO_BROWSER_VALIDATOR_MUTATION_AUTHORITY', 'NO_STATIC_VALIDATOR_MUTATION_AUTHORITY', 'NO_ANCHOR_EVIDENCE_CONTENT_MUTATION_AUTHORITY', 'NO_AWARD_OUTCOME_AUTHORITY', 'NO_SEMANTIC_AUTHORITY', 'NO_CANONICAL_IDENTITY_AUTHORITY', 'NO_H_EARTH_RUNTIME_AUTHORITY', 'NO_RENDERER_AUTHORITY', 'NO_TERRAIN_AUTHORITY', 'NO_GEOMETRY_AUTHORITY', 'NO_WORLD_AUTHORITY', 'NO_GAMEPLAY_AUTHORITY', 'NO_MERGE_DEPLOYMENT_RELEASE_OR_PUBLICATION_AUTHORITY']),

...
export const H_EARTH_RUN_8E_R2E_CONTROL = freeze({
  ...
  preflightFailureBeingResolved: {
    runId: 30240950338,
    jobId: 89897847300,
    artifactId: 8643225287,
    artifactDigest: 'sha256:f4f519e19da3298c341781887fddcab58a2067b18db733344addd99de6ecd83f',
...
export function evaluateHEarthRun8ER2EControl(candidate = H_EARTH_RUN_8E_R2E_CONTROL) {
  ...
  if (candidate?.preflightFailureBeingResolved?.failureCode !== 'REQUESTED_PATH_UNRESOLVED') issues.push('R2E_PREFLIGHT_FAILURE_CLASS_INVALID');
  if (!candidate?.requiredProofs?.includes('GIT_SCOPE_REGISTRY_SCOPE_AND_LOADER_RESOLUTION_SET_EQUALITY')) issues.push('R2E_SCOPE_EQUALITY_PROOF_MISSING');

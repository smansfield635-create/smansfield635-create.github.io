...
check('BRAIN_SELF_CONTAINED',files.brainJs.includes(OBJECT_CONTRACT)&&files.brainJs.includes('anatomical-canvas-v7-continuity')&&!/compass-capability-orbit|compass-orbit-plaque|compass-object-caption/.test(files.brainJs));
...
check('TROPHY_RENDERER_BOUNDED',files.trophyJs.includes('procedural-webgl-trophy-v3')&&files.trophyJs.includes('continuous-cup-collar-stem-foot')&&!/compass-capability-orbit|compass-orbit-plaque|compass-object-caption/.test(files.trophyJs));

...
await browser.close();
const out={schema:'DGB_COMPASS_BRAIN_V9_VOLUMETRIC_BASELINE_QUALIFICATION_v1',status:failed?'FAIL':'PASS',surface:'/inspection/compass/brain-v9/',expectedRenderer:EXPECTED_RENDERER,checks};

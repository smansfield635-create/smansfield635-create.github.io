(() => {
  ...
  const diagnostic = Object.freeze({
    productIdentity:"COHERISCOPE",
    route:"/coherence-diagnostic/",
    continuity:"P5_ASSESSMENT_TO_P6_INSTRUMENT",
  ...
  const brain = Object.freeze({
    ...
    projection:"CANONICAL_PARAMETRIC_MESH_FRONT_PROJECTION",
    ...
    rows:34,
    cols:54,
    fold:Object.freeze({primary:[7.2,5.1,.78],secondary:[13.4,-7.7,.42],tertiary:[19.7,11.2,.24],quaternary:[27.3,-16.1,.13],crossA:[5.3,-9.1,.34],crossB:[15.2,4.4,.18]}),
    appendages:Object.freeze({cerebellum:[0,-.55,.56,.27],pons:[0,-.57,.23,.18],brainstem:Object.freeze([[-.58,.16,.13],[-.76,.125,.10],[-.95,.085,.068],[-1.10,.055,.045]].map(Object.freeze))})
  });
  ...
  const house = Object.freeze({
    ...
    projection:"CANONICAL_IDENTITY_FRONT_ELEVATION",
    principalSpan:27,
    ...
    elevation:Object.freeze({towerCenters:Object.freeze([-.34,.34]),dormerCenters:Object.freeze([-.22,0,.22]),windowCenters:Object.freeze([-.30,-.15,.15,.30]),floorY:Object.freeze([.43,.62]),portalCenter:0,courtRadius:.23})
  });
  ...
  const windowFallback = Object.freeze({
    ...
    panes:Object.freeze([
      ...
      ["lower-right-edge","amber",[[332,338],[324,446],[398,470],[414,332]]],["lower-left-deep","blue",[[82,470],[116,594],[192,530],[156,446]]],
      ["lower-center-left","paleViolet",[[156,446],[192,530],[240,624],[240,500],[216,430]]],["lower-center-right","paleRose",[[264,430],[240,500],[240,624],[288,530],[324,446]]],
      ["lower-right-deep","cyan",[[324,446],[288,530],[364,594],[398,470]]],["base-left","amber",[[116,594],[168,660],[240,676],[240,624],[192,530]]],
      ["base-right","blue",[[288,530],[240,624],[240,676],[312,660],[364,594]]]
    ].map(Object.freeze))
  });
  ...
  const audralia = Object.freeze({
    ...
    bounds:Object.freeze({uMin:-2180,uMax:2130,vMin:-2310,vMax:320}),continentFootprintAreaTarget:0.70,continentLinearScale:Math.sqrt(.70),continentScaleAnchor:Object.freeze([0,-128]),
    ...
    greatLakeAnchors:Object.freeze([[-1010,-1330],[-955,-1490],[-840,-1590],[-705,-1625],[-610,-1680],[-470,-1640],[-360,-1695],[-225,-1620],[-135,-1500],[-175,-1385],[-105,-1250],[-190,-1135],[-330,-1095],[-455,-1015],[-590,-1050],[-715,-995],[-830,-1070],[-900,-1175],[-1035,-1225]].map(Object.freeze)),
    inletIslandAnchors:Object.freeze([
      [[700,-1045],[765,-1125],[880,-1150],[1005,-1105],[1080,-1015],[1010,-940],[920,-915],[855,-850],[750,-885],[685,-955]].map(Object.freeze),
      [[430,-875],[455,-940],[530,-970],[610,-935],[645,-875],[590,-825],[555,-760],[480,-775],[405,-820]].map(Object.freeze)
    ].map(Object.freeze)),
    offshoreIslandAnchors:Object.freeze([
      [[-1820,-1010],[-1760,-1100],[-1660,-1140],[-1570,-1090],[-1540,-1000],[-1620,-935],[-1725,-930],[-1795,-955]].map(Object.freeze),
      [[-1610,-1510],[-1540,-1595],[-1435,-1620],[-1350,-1560],[-1365,-1470],[-1460,-1425],[-1560,-1450]].map(Object.freeze),
      [[-1840,-1320],[-1800,-1380],[-1730,-1400],[-1675,-1350],[-1695,-1280],[-1770,-1260]].map(Object.freeze)
    ].map(Object.freeze)),
    summitAnchors:Object.freeze([[-1180,-1190],[-900,-1010],[-620,-850],[-320,-720],[0,-640],[330,-760],[610,-940],[850,-1160],[1010,-1380]].map(Object.freeze))
  });
  ...
  const trophy = Object.freeze({
    ...
    neckCollar:Object.freeze([[.18,.255],[.16,.225],[.132,.188],[.118,.142]].map(Object.freeze)),
    stem:Object.freeze([[.118,.145],[.108,.065],[.104,-.12],[.112,-.225],[.135,-.305]].map(Object.freeze)),
    footUpper:Object.freeze([[.135,-.305],[.18,-.34],[.27,-.385],[.355,-.425],[.382,-.455]].map(Object.freeze)),
    footLower:Object.freeze([[.382,-.455],[.365,-.485],[.30,-.515],[.215,-.53]].map(Object.freeze)),

...
const CONTRACT=JSON.parse(fs.readFileSync(path.join(HERE,'gen1980-material-evidence-contract.v1.json'),'utf8'));
const args={};
...
check('MANIFEST_SCHEMA',manifest.schema==='MIRRORLAND_GEN1980_MATERIAL_EVIDENCE_MANIFEST_v1',{observed:manifest.schema});
...
const receipt={
  schema:'MIRRORLAND_GEN1980_MATERIAL_EVIDENCE_VERIFICATION_RECEIPT_v1',

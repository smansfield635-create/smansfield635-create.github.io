...
function presentationLabel(anchor) {
  return anchor.dataset.characterLabel || `Reserved position ${anchor.dataset.anchor}`;
}
...
anchorList.setAttribute('aria-label', 'Eight character card anchors');

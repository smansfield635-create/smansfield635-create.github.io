...
check("observer cannot access truth", "access hidden truth" in roles["roles"]["observer_team"]["may_not"])
check("protocol authority cannot author systems", "author primary systems" in roles["roles"]["protocol_authority"]["may_not"])

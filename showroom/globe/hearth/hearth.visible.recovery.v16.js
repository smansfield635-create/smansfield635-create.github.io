// /showroom/globe/hearth/hearth.visible.recovery.v16.js
// HEARTH_VISIBLE_RECOVERY_ROUTE_TNT_v16
// Full-file replacement / new file.
// Purpose:
// - Mount a visible, draggable Hearth globe from a brand-new route-file path.
// - Avoid stale index.js and stale hearth.climate.route.js execution.
// - Do not block visible rendering on legacy child contracts.
// No generated image. No GraphicBox. No visual-pass claim.

(() => {
  "use strict";

  const CONTRACT = "HEARTH_VISIBLE_RECOVERY_ROUTE_TNT_v16";
  const RECEIPT = "HEARTH_VISIBLE_RECOVERY_ROUTE_RECEIPT_v16";
  const VERSION = "2026-05-10.hearth-visible-recovery-route-v16";

  const TAU = Math.PI * 2;
  const DEG = Math.PI / 180;

  window.__HEARTH_ACTIVE_ROUTE_FILE__ = "/showroom/globe/hearth/hearth.visible.recovery.v16.js";
  ...
  function status(value) {
    ...
    document.documentElement.dataset.hearthActiveRouteFile = "/showroom/globe/hearth/hearth.visible.recovery.v16.js";
    ...
    if (node) {
      node.textContent = [
        "Hearth visible recovery v16 route.",
        `Status ${value}`,
        `Route ${CONTRACT}`,
        `Receipt ${RECEIPT}`,
        `Version ${VERSION}`,
        "Active route /showroom/globe/hearth/hearth.visible.recovery.v16.js",
